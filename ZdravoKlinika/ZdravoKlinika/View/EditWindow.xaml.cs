...
namespace ZdravoKlinika.View
{
    ...
    public partial class EditWindow : Window
    {
        ...
        private void Confirm_Click(object sender, RoutedEventArgs e)
        {
            ...
            //appointmentController.EditAppointment(this.appointment.AppointmentId, this.appointment.Doctor.PersonalId, patientId, dateTime, false, actualType, room, duration);
            Close();
        }
